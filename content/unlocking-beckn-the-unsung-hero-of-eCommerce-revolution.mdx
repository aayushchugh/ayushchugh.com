...
We need a centralised platform/middleman to connect these platforms with each other.

## The Solution

Here is where Beckn comes in. Beckn (short for beckn protocol) is an open protocol for decentralized commerce.
