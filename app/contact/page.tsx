...
export const metadata: Metadata = {
	title: "Contact",
	description:
		"Get in touch with Ayush Chugh via email, Twitter, GitHub, Peerlist, LinkedIn, and more.",
	openGraph: {
		...
		images: [
			{
				url: "https://cdn.ayushchugh.com/open-graph/contact.png", // Add a relevant Open Graph image for social sharing
				width: 1200,
				height: 630,
